 ...
 * @param {string} opts.verifyUrl   – full URL to the email-verification endpoint
 */
export function verifyEmailTemplate({ firstName, verifyUrl }) {
    const subject = "Verify your Castra email address";
...
<body style="margin:0;padding:0;background:#0A0A0A;font-family:'Segoe UI',Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0A0A0A;padding:40px 16px;">
        ...
        <table width="100%" style="max-width:520px;background:#111111;border-radius:16px;border:1px solid #27272a;overflow:hidden;">
          ...
          <tr>
            <td style="padding:36px 32px 28px;">
              ...
              <h1 style="margin:0 0 8px;font-size:22px;font-weight:700;color:#ffffff;text-align:center;">Confirm your email</h1>
              <p style="margin:0 0 24px;font-size:14px;color:#a1a1aa;text-align:center;line-height:1.6;">
                Welcome to Castra, ${firstName}! Click the button below to verify your email address
              ...
              <p style="margin:0 0 20px;font-size:12px;color:#71717a;text-align:center;line-height:1.6;">
                ...
                If you didn't create a Castra account, you can safely ignore this email.
              </p>
              ...
              <div style="background:#18181b;border-radius:8px;padding:12px 16px;margin-bottom:4px;">
                ...
                <p style="margin:0;font-size:11px;color:#C6A16A;word-break:break-all;">${verifyUrl}</p>
              </div>
          ...
          <tr>
            <td style="padding:20px 32px;border-top:1px solid #27272a;text-align:center;">
              <p style="margin:0;font-size:11px;color:#52525b;line-height:1.6;">
                You're receiving this because an account was created at
    ...
    const text = `Welcome to Castra, ${firstName}!
